...
public class FlightsQuery {
		...
		public static void main(String[] args) throws IOException {
			...
			Iterator<Object[]> recordsGeneric = new Transform(new ParseCSVLine(), lines);
			Iterator<FlightRecord> records = new Transform(new ConvertToRecord(), recordsGeneric);
		...
		private static class ConvertToRecord implements Function<Object[], FlightRecord> {
		...
		// "10,cat,dog,22"
		// [10, "cat", "dog", 22]
		private static class ParseCSVLine implements Function<String, Object[]> {
