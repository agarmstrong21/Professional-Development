...
public class TransformToManyTest {
		
		public TransformToManyTest() {
		}
		...
		public void emptyTest() {
			...
			TransformToMany<Integer,Integer> op = new TransformToMany(new TwoCopies(), input.iterator());
		...
		public void removalTest() {
			...
			List<Integer> input = Arrays.asList(inputValues);
			TransformToMany<Integer,String> op = new TransformToMany(new RemoveAndConvert(), input.iterator());
		...
		public static class TwoCopies implements Function<Integer, List<Integer>> {
		...
		public static class RemoveAndConvert implements Function<Integer, List<String>> {
